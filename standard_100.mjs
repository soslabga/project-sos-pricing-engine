...
const py=105, rent=440, depo=7500, mgmtRate=2.8, partTime=0, sales=50; // 정상화 이후(steady-state), 소상공인 평균(20~100만) 상단. 런칭기(1~6개월)는 200만 별도 민감도 참고
...
console.log('120평: 33실/90석 · BEP 51.1% (참고: pangyo_120.mjs 최신 실행 결과, 실매물 월세 432만, 세일즈50만 적용)');
console.log('150평: 53실/110석 · BEP 52.6% (참고: pangyo_150.mjs 최신 실행 결과, 실매물 월세 560만, 세일즈50만 적용)');
