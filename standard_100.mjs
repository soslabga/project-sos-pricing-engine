...
const capex=Math.round((py*150+py*7+rm*7+200+seat*23.65+50)*1.05); // 전기통신11→7만/평 확정검증(평촌임대차계약서 37평×전기및네트워크.png 247.5만원=6.69만/평, 판교 통신전용4.05만/평과 역산 정합) + 도어락7만/룸 + 보안200만
...
console.log('120평: 33실/90석 · BEP 55.9% (최신 실행 결과)');
console.log('150평: 53실/110석 · BEP 55.1% (최신 실행 결과)');
