...
export default function RefundPage() {
  return (
    <PolicyLayout eyebrow="CANCELLATION & REFUND" title="취소·환불 기준">
      ...
      <section><h2>환불 처리</h2><p>홈페이지 내 예약에서 휴대폰 인증 후 환불률과 환불 예정액을 확인하고 취소할 수 있습니다. 취소 접수 후 원결제 수단으로 환불합니다. 카드사와 결제기관 처리기간에 따라 실제 입금일까지 영업일 기준 시간이 걸릴 수 있습니다.</p></section>
    </PolicyLayout>
  );
}
