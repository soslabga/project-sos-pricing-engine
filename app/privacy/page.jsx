...
export default function PrivacyPage() {
  return (
    <PolicyLayout eyebrow="PRIVACY POLICY" title="개인정보처리방침">
      <section><h2>1. 처리하는 정보와 목적</h2><div className="policy-table"><div><b>예약 및 이용계약</b><span>예약자 이름, 휴대폰 번호, 예약 공간·일시, 결제금액</span></div><div><b>출입 안내</b><span>휴대폰 번호로 예약 확인과 6자리 출입코드 발송</span></div><div><b>고객 응대</b><span>문의·취소·환불·분쟁 처리 기록</span></div></div></section>
      ...
      <section><h2>5. 안전성 확보조치</h2><p>접근권한 제한, 전송구간 암호화, API 키의 서버 환경변수 보관, 예약 데이터 접근기록 관리와 정기 점검을 시행합니다. 출입코드는 예약마다 다르게 발급하고 이용기간이 끝나면 출입 권한을 종료합니다.</p></section>
