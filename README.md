...
판교점 1인실 10개와 멀티룸 A/B를 예약하는 Next.js App Router 웹사이트입니다. 결제는 데모용 mock이며 예약 완료 시 6자리 출입코드를 발급합니다.
...
SOLAPI_API_SECRET=
SOLAPI_SENDER=
SOS_ADDRESS=판교 주소, TBD
SOS_WIFI_PASSWORD=현장 비밀번호
SOS_SUPPORT_PHONE=원격관제 번호
```

문자 본문은 `lib/sms-solapi.js`에 있으며 요청받은 예약 안내 전문을 예약자명, 날짜, 공간, 결제금액, 출입코드에 맞춰 생성합니다.
