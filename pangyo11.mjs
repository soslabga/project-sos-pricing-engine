...
// [가격정책 최종확정 2026-07-01] 하이브리드: 경쟁사가 확인된 지역은 경쟁사가×할인 vs 원가+25%마진 중 더 높은 값 채택(마진보호 하한). 판교=FF 4인실거래222.48만 대비 약-20%=178만(44.5만/석), 이는 cost-plus(36.2만/석)보다 높아 경쟁사밴드 채택. 미조사 신규지역은 cost-plus(원가÷0.635)를 기본값으로 사용
const full_rev=mix[4]*178+mix[2]*120+mix[1]*70;
