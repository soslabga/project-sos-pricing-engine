...
// 줄4: 6×2인(2200) + 1인 4개(2열×2행으로 가로 분할)
// 2인 6개: 0.12~13.92m / 1인 섹션: 13.92~17.72m(3.8m, 2열 각1.85)
// 1인 상하 분할: y=11.02~12.42(h=1.4) / y=12.52~13.92(h=1.4)
x=0.12;
for(let i=0;i<6;i++){room(x,11.02,2.2,2.9,2,'#dce8ff','2200×2900');x+=2.3;}
// 1인 4개: 2열(w=1.85) × 2행(h=1.4)
const x1=x, x2=x+1.99; // x1=13.92, x2=15.91 (1890×1400=0.80평)
room(x1,11.02,1.89,1.4,1,'#ede8ff','1890×1400'); // 상-좌
room(x2,11.02,1.89,1.4,1,'#ede8ff','1890×1400'); // 상-우
room(x1,12.52,1.89,1.4,1,'#ede8ff','1890×1400'); // 하-좌
room(x2,12.52,1.89,1.4,1,'#ede8ff','1890×1400'); // 하-우
