...
// [가격정책 정정 2026-07-01] "FF판교 4인실거래222.48만(-28%)"은 판교_코워킹_입지수익성_보고.md 98행에 "실제 프로모션율 미확인, 28%는 SP 기준 추정"이라고 명시된 미검증 가정이었음(정가만 검증됨: 4인309만/7인406만/10인559만). 근거 없는 정가 임의할인(-20% 등)도 신뢰 못 함 → cost-plus(원가÷0.635=25%마진, 36.2만/석)로 원복
const full_rev=mix[4]*145+mix[2]*94+mix[1]*52;
