...
// [가격정책 확정 2026-07-01] 원가+25%마진(100%가동 기준) cost-plus 전국표준 산식. 좌석당원가(고정비÷좌석)÷0.635. 경쟁사가(FF판교 실거래 222.48만=55.6만/석)는 상한체크만 — 145만은 이보다 훨씬 낮아 통과. 시장조사 가능하면 상향조정, 불가하면 이 값 유지
